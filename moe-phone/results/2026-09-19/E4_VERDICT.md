...
- Criterion (spin=1, down Q4_0, host-visible median): **k=1 1.128 ms (positive needs <= 0.15); k=2 1.468 ms (kill at >= 0.40)**. KILL.
  Device time: k=1 0.805 ms, k=2 1.125 ms. In the same session the bit-exact v4 took 0.58 ms host at k=1 (spin=1). The tolerant
  kernel is slower: unquantised fp32 activations cost more than the integer path saved.
