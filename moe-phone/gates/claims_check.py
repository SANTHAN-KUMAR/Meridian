...
CLAIMS = [
    ...
    dict(id="pin_recycle_best",
         ...
         value=lambda A: next(c["decode_tok_s_median"] for c in A["bpin"]["cells"] if c["cell"] == "pin_t4_recycle")),
    dict(id="pin_unpinned_median",
         ...
         value=lambda A: next(c["decode_tok_s_median"] for c in A["bpin"]["cells"] if c["cell"] == "unpinned_t4_io4")),
