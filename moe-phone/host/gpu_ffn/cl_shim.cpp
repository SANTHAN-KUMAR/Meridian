...
FWD(cl_int, clGetEventProfilingInfo, (cl_event ev, cl_profiling_info i, size_t s, void * v, size_t * r), (ev, i, s, v, r))
FWD(cl_int, clReleaseEvent, (cl_event ev), (ev))
FWD(cl_int, clWaitForEvents, (cl_uint n, const cl_event * ev), (n, ev))
FWD(cl_int, clReleaseCommandQueue, (cl_command_queue q), (q))
